// ===== App config =====
const SECTION_META = {
  1: { title: '一、單選題', desc: '單選題，共 3 題（第 58–60 題）', color: 1 },
  2: { title: '二、題組', desc: '閱讀資料後回答多個子題（單選），共 11 組，每組算 1 題，10 組為一份', color: 2 },
  3: { title: '三、混合題', desc: '閱讀資料後回答選擇＋問答題，共 10 組，每組算 1 題', color: 3 },
};
